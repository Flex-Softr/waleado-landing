  ...
  return (
    <section className="py-20 md:py-28 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-3xl overflow-hidden border border-emerald-500/40 bg-emerald-950 p-8 sm:p-14 lg:p-16 shadow-2xl shadow-emerald-500/20">
          {/* Ambient Glows */}
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto space-y-6">
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-base font-bold text-slate-950 bg-emerald-400 hover:bg-emerald-300 shadow-xl shadow-emerald-500/30 hover:scale-105 transition-all duration-200"
              >
